...
let StripeController = class StripeController {
    ...
    async updatePaymentIntent(params, payload) {
        return this.stripeService.updatePaymentIntent(params.payment_intent_id, payload);
    }
};
__decorate([
...
__decorate([
    common_1.Put('/update-payment-intent/:payment_intent_id'),
    __param(0, common_1.Param()),
    __param(1, common_1.Body('payload')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], StripeController.prototype, "updatePaymentIntent", null);
